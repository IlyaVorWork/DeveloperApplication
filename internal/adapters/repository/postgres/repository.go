...
type DeveloperApplicationRepository interface {
	...
	UpdateDeveloperApplication(ctx context.Context, arg developer_application.UpdateDeveloperApplicationParams) (developer_application.DeveloperApplication, error)
