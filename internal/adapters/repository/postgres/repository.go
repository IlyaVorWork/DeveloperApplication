...
type DeveloperApplicationRepository interface {
	...
	SetVerificationProcess(ctx context.Context, id uuid.UUID, processID uuid.UUID) (developer_application.DeveloperApplication, error)
	UpdateVerificationStatus(ctx context.Context, processID uuid.UUID, status string) error
